  ...
  class TodoList extends HTMLElement {
    constructor() {
      ...
      todoListContainer.innerHTML = `
        ...
        <ul class="item-list">
          ${listItems.map(item => `
            <li>${item}
              <button class="todo-list-remove-item icon">&ominus;</button>
            </li>
          `).join('')}
        </ul>
        <div>
          ...
          <button class="todo-list-add-item icon">&oplus;</button>
        </div>
      `;
    ...
    addListItem(e) {
      ...
      if (textInput.value) {
        ...
        button.classList.add('todo-list-remove-item', 'icon');
    ...
    connectedCallback() {
      ...
      const addElementButton = this.shadowRoot.querySelector('.todo-list-add-item');
